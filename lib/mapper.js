...
exports.productViewed = function(msg, settings){
  ...
  extend(payload, addContext(msg, settings));
  payload.ContentId = msg.proxy('properties.id');
  payload.ContentType = msg.proxy('properties.category');
  payload.Description = msg.proxy('properties.description');
  payload.Currency = msg.proxy('properties.currency');
  payload.valueToSum = msg.revenue() || msg.price();
